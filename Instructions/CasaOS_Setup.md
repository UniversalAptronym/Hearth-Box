...
9. Repeat Step 8, but this time type `https://casaos-appstore.paodayag.dev/linuxserver.zip` into the bar and press Enter. This will add apps from the Linux Server community. You can find more community app stores to install at [this link](https://awesome.casaos.io/content/3rd-party-app-stores/list.html#_3-casaos-coolstore) if you are interested.
